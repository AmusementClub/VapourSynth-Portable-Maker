...
.\VapourSynth\python.exe -m pip install https://github.com/SAPikachu/igstools/archive/master.zip --no-warn-script-location
...
Remove-Item -Path .\pylib -Recurse -Force
